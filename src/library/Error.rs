...
#[diagnostic(help("Blok kodlarda her blok için sadece +1 tab (\\t) kullanmaya dikkat edin."))]
...
#[diagnostic(help("Bu değişkenin daha önceden tanımlanmış olduğundan emin olun."))]
...
#[diagnostic(help("Bu fonksiyonun daha önceden tanımlanmış olduğundan emin olun."))]
...
#[derive(Error, Debug, Diagnostic)]
#[error("Token Hatası")]
#[diagnostic(help("Beklenen token: {expected:#?}\nAlınan token: {got:?}"))]
